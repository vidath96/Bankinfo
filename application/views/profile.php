				...
				<?php foreach ($userres as $user) : ?>
					<form action="#" method="POST">
						...
						<div class="form-group">
							...
							<input type="text" name="firstname" value="<?= $user->user_fname ?>" class="form-control" required readonly>
						</div>
						<div class="form-group">
							<label class="label form-label">Last Name</label><br>
							<input type="text" name="lastname" value="<?= $user->user_lname ?>" class="form-control" required readonly>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="number" name="contactno" value="<?= $user->contact ?>" class="form-control" required readonly>
						</div><br>
					<?php endforeach; ?>
